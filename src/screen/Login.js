             ...
             <View style={styles.main}>
              ...
              <View style={styles.mainContainerTwo}>
                  <View  style={{ ...StyleSheet.absoluteFillObject, backgroundColor: "#0000A5", }} />
                      <View style={{ flex: 1, backgroundColor: "white", borderTopLeftRadius: 75,  borderTopRightRadius: 75,  marginVertical: -60, }}>
                          <SafeAreaView style={styles.container}>
                              ...
                              />
                                ...
                                />
                                  ...
                                  <TouchableOpacity style={styles.buttonGroup} onPress={() => handleSubmit()}>
                                    <Button style={styles.submit}  mode="contained" >Login</Button>
                                  </TouchableOpacity>
